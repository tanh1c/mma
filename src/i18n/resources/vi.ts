...
const vi: TranslationShape<typeof en> = {
  ...
  navigation: {
    ...
    promotionFinances: 'Tài chính giải đấu',
    rankings: 'Bảng xếp hạng',
    tournaments: 'Giải Grand Prix',
    leagues: 'Hệ thống giải',
    socialHub: 'Mạng xã hội',
    historyStats: 'Lịch sử & Thống kê',
    statsBoard: 'Bảng thống kê',
  ...
  leagues: {
    title: 'Hệ thống giải thế giới', playerControlled: 'Người chơi quản lý', aiControlled: 'AI quản lý', domesticChampion: 'Vô địch quốc nội', domesticRankings: 'Bảng xếp hạng quốc nội', championsCupQualification: 'Suất Champions Cup', challengeCupQualification: 'Suất Challenge Cup', internationalChampions: 'Nhà vô địch quốc tế', noChampion: 'Đang bỏ trống'
  },
  contractMarket: {
    eyebrow: 'Thi đấu', title: 'Thị trường hợp đồng', description: 'Rao bán võ sĩ có hợp đồng và gửi đề nghị kín trong kỳ chuyển nhượng theo mùa.', budget: 'Ngân sách hợp đồng', mode: 'Chế độ tài chính', viewFinances: 'Xem tài chính giải đấu', sectionsLabel: 'Các mục thị trường hợp đồng', windowStatus: 'Trạng thái kỳ', opens: 'Mở ngày', closes: 'Đóng ngày', daysRemaining: 'Còn {{count}} ngày', openHelp: 'Thị trường đang mở. Mọi hoạt động hợp đồng phải thực hiện tại đây.', closedHelp: 'Đề nghị và danh sách bị khóa đến kỳ tiếp theo.', unknownFighter: 'Võ sĩ không xác định', freeAgent: 'Võ sĩ tự do', selectFighter: 'Chọn võ sĩ', tabs: { available: 'Có thể ký', listings: 'Đang rao bán', incoming: 'Đề nghị nhận được', offers: 'Đề nghị của tôi', history: 'Lịch sử' }, status: { scheduled: 'Đã lên lịch', open: 'Đang mở', resolving: 'Đang xử lý', closed: 'Đã đóng' }, interested: '{{count}} giải đang quan tâm', competition: 'Cạnh tranh: {{level}}', minimumFee: 'Giá tối thiểu {{amount}}', minimumFeeLabel: 'Giá tối thiểu', expiring: 'Hợp đồng kết thúc {{date}}', affordable: 'Đủ ngân quỹ', unaffordable: 'Không đủ ngân quỹ', transferFee: 'Phí chuyển nhượng', payPerFight: 'Tiền mỗi trận', winBonus: 'Thưởng chiến thắng', fights: 'Số trận', submit: 'Gửi đề nghị kín', revise: 'Sửa đề nghị', offerSubmitted: 'Đã gửi đề nghị.', listFighter: 'Rao bán võ sĩ', list: 'Rao bán', listed: 'Đã rao bán võ sĩ.', withdraw: 'Rút lại', withdrawn: 'Đã rút lại.', accept: 'Chấp nhận phí', reject: 'Từ chối phí', accepted: 'Đã chấp nhận phí.', rejected: 'Đã từ chối phí.', noItems: 'Không có dữ liệu trong mục này.', marketRequired: 'Hoạt động hợp đồng được xử lý qua thị trường đang mở.', reasons: { submitted: 'Đã gửi đề nghị', sellerAccepted: 'Bên bán chấp nhận mức phí', sellerRejected: 'Bên bán từ chối mức phí', sellerNoResponse: 'Bên bán không duyệt mức phí', sellerFeeTooLow: 'Phí chuyển nhượng quá thấp', betterExpectedPay: 'Thu nhập kỳ vọng tốt hơn', betterPrestige: 'Giải đấu danh tiếng hơn', betterTitleOpportunity: 'Cơ hội tranh đai tốt hơn', loyalty: 'Trung thành với giải hiện tại', outbid: 'Một gói đề nghị khác được ưu tiên', ownershipChanged: 'Quyền sở hữu võ sĩ đã thay đổi', windowNotOpen: 'Thị trường hợp đồng chưa mở', insufficientCash: 'Bên mua không còn đủ tiền', internationalCompetitionActive: 'Võ sĩ vẫn đang dự giải quốc tế', invalidTerms: 'Hãy nhập điều khoản hợp đồng là số nguyên hợp lệ', noEligibleOffer: 'Không còn đề nghị đủ điều kiện', invalid: 'Gói đề nghị không còn hợp lệ' }
  },
  promotionFinances: {
    eyebrow: 'Quản lý', title: 'Tài chính giải đấu', description: 'Tài chính vận hành chính xác của mọi giải đấu.', selectPromotion: 'Giải đấu', cash: 'Số dư tiền mặt', debtLimit: 'Giới hạn nợ', headroom: 'Dư địa còn lại', liabilities: 'Nợ phải trả tồn đọng', runway: 'Thời gian duy trì ước tính', months: '{{count}} tháng', mode: 'Chế độ tài chính', modes: { growth: 'Tăng trưởng', stable: 'Ổn định', cautious: 'Thận trọng', recovery: 'Phục hồi' }, contractBudget: 'Ngân sách hợp đồng', monthlyIncome: 'Thu nhập hàng tháng', monthlyExpenses: 'Chi phí hàng tháng', monthlyNet: 'Dòng tiền tháng', sponsorIncome: 'Thu nhập tài trợ', mediaIncome: 'Thu nhập truyền thông', operatingCost: 'Chi phí vận hành', rosterRetainer: 'Phí duy trì đội hình', brandSpend: 'Đầu tư thương hiệu', recentEvent: 'Lãi/lỗ sự kiện gần nhất', ledger: 'Sổ cái giải đấu', ledgerCaption: 'Giao dịch giải đấu theo thứ tự quyết toán', brandHistory: 'Lịch sử đầu tư thương hiệu', date: 'Ngày', category: 'Hạng mục', transactionDescription: 'Mô tả', amount: 'Số tiền', balance: 'Số dư sau giao dịch', investTitle: 'Đầu tư thương hiệu', investAmount: 'Số tiền đầu tư', projectedEffect: '+{{fanbase}} người hâm mộ, +{{reputation}} danh tiếng', invest: 'Đầu tư', rivalReadOnly: 'Tài chính của giải đối thủ chỉ được xem.', noEntries: 'Chưa có giao dịch.', reasons: { invalidAmount: 'Nhập số nguyên tối thiểu {{minimum}}.', recoveryMode: 'Không thể đầu tư thương hiệu trong chế độ phục hồi.', outstandingLiabilities: 'Hãy thanh toán nợ tồn đọng trước khi chi tiêu tùy chọn.', debtLimit: 'Giao dịch này sẽ vượt giới hạn nợ.', requiredReserve: 'Giao dịch này sẽ dùng đến dự trữ vận hành bắt buộc.', success: 'Đã hoàn tất đầu tư thương hiệu.' }, categories: { eventGate: 'Doanh thu vé', eventMedia: 'Truyền thông sự kiện', eventSponsor: 'Tài trợ sự kiện', fighterPurse: 'Thù lao võ sĩ', winBonus: 'Thưởng chiến thắng', venue: 'Địa điểm', eventMarketing: 'Quảng bá sự kiện', monthlySponsor: 'Tài trợ hàng tháng', monthlyMedia: 'Truyền thông hàng tháng', operatingCost: 'Chi phí vận hành', rosterRetainer: 'Phí duy trì đội hình', liabilityPayment: 'Thanh toán nợ', brandInvestment: 'Đầu tư thương hiệu', transferFee: 'Phí chuyển nhượng', objectiveReward: 'Thưởng mục tiêu', drama: 'Sự cố hậu trường', legacy: 'Tài chính cũ' }
  },
  tournaments: {
    eyebrow: 'Thể thức thi đấu', title: 'Giải Grand Prix', description: 'Tổ chức nhánh loại trực tiếp 4 hoặc 8 người để xác định ứng viên số một.', domestic: 'Quốc nội', international: 'Quốc tế', create: 'Tạo Grand Prix', newTitle: 'Giải Grand Prix mới', close: 'Đóng biểu mẫu giải đấu', name: 'Tên giải đấu', weightClass: 'Hạng cân', format: 'Thể thức', fourMan: 'Grand Prix 4 người', eightMan: 'Grand Prix 8 người', titleShot: 'Hứa cơ hội tranh đai tuyệt đối', titleShotHelp: 'Người thắng Grand Prix được quyền tranh đai tuyệt đối.', selectParticipants: 'Chọn {{count}} võ sĩ', selected: 'Đã chọn {{selected}} / {{count}}', eligibility: 'Chỉ võ sĩ đã ký hợp đồng, khỏe mạnh, chưa có lịch đấu trong hạng cân này mới đủ điều kiện. Xếp hạt giống theo điểm ELO; OVR phá hòa.', noEligible: 'Không có võ sĩ đủ điều kiện ở {{weightClass}}. Hãy ký thêm người hoặc giải phóng võ sĩ đã có lịch.', participant: 'Võ sĩ', reserve: 'Dự bị ({{selected}}/{{count}})', cancel: 'Hủy', createTournament: 'Tạo giải đấu', exactParticipants: 'Hãy chọn đúng {{count}} võ sĩ.', list: 'Danh sách giải đấu', filters: { all: 'Tất cả', active: 'Đang diễn ra', completed: 'Đã hoàn thành', cancelled: 'Đã hủy' }, noMatches: 'Không có giải đấu nào khớp bộ lọc.', winner: 'Người thắng: {{name}}', created: 'Ngày tạo: {{date}}', bracket: 'Nhánh đấu & Chi tiết', statusDivision: 'Trạng thái: {{status}} · Hạng cân: {{division}}', scheduleQuarterfinals: 'Xếp lịch tứ kết', scheduleSemifinals: 'Xếp lịch bán kết', scheduleFinal: 'Xếp lịch chung kết', cancelConfirm: 'Hủy giải đấu này? Các trận đã xếp lịch sẽ bị gỡ.', cancelGp: 'Hủy GP', viewStats: 'Xem thống kê trận →', statsAfterEvent: 'Thống kê có sau khi sự kiện kết thúc.', quarterfinals: 'Tứ kết', quarterfinal: 'Tứ kết {{number}}', semifinals: 'Bán kết', semifinal: 'Trận bán kết {{number}}', final: 'Chung kết', grandPrixFinal: 'Chung kết Grand Prix', championshipFinal: 'Trận chung kết', linkedEvent: 'Sự kiện liên kết', pending: 'Chưa xác định', replacementReserve: 'Dự bị', gpStatus: 'Trạng thái GP: {{status}}', earliestRetry: 'Có thể thử lại sớm nhất: {{date}}', scheduleRound: 'Xếp lịch {{round}}', reserves: 'Võ sĩ dự bị', noReserves: 'Chưa chỉ định võ sĩ dự bị.', ready: 'Sẵn sàng', titleShotPromised: 'Đã hứa cơ hội tranh đai', titleShotDescription: 'Người thắng chắc chắn được tranh đai tuyệt đối với nhà vô địch hạng cân.', history: 'Lịch sử & Nhật ký giải đấu', selectPrompt: 'Chọn một giải trong danh sách hoặc tạo giải mới để xem nhánh đấu và chi tiết.', scheduleTitle: 'Xếp lịch {{round}}', scheduleDescription: 'Chọn một sự kiện sắp tới để tổ chức các trận của giải. Các trận sẽ được thêm vào card sự kiện.', noEvents: 'Chưa xếp sự kiện sắp tới!', noEventsHint: 'Hãy tạo sự kiện từ mục Xếp sự kiện trước.', chooseEvent: 'Chọn sự kiện', selectEvent: '-- Chọn sự kiện --', confirmScheduling: 'Xác nhận xếp lịch', round: { quarterfinal: 'Các trận tứ kết', semifinal: 'Các trận bán kết', final: 'Chung kết Grand Prix' }
  },
  statsBoard: {
    eyebrow: 'Kỷ lục', title: 'Bảng thống kê', description: 'Kỷ lục có thể sắp xếp của võ sĩ, trận đấu, sự kiện, giải đấu, danh hiệu và Grand Prix.', sectionsLabel: 'Các miền thống kê', showMore: 'Xem thêm', empty: 'Không có dữ liệu khớp bộ lọc.', international: 'Quốc tế', tabs: { fighters: 'Võ sĩ', fights: 'Trận đấu', events: 'Sự kiện', promotions: 'Giải đấu', titles: 'Danh hiệu', tournaments: 'Grand Prix' }, filters: { period: 'Thời kỳ', scope: 'Phạm vi', division: 'Hạng cân', allTime: 'Mọi thời đại', currentSeason: 'Mùa hiện tại', world: 'Thế giới', international: 'Quốc tế', allDivisions: 'Mọi hạng cân' }, columns: { record: 'Kỷ lục', fighter: 'Võ sĩ', division: 'Hạng cân', value: 'Giá trị', sample: 'Mẫu', fight: 'Trận đấu', event: 'Sự kiện', date: 'Ngày', promotion: 'Giải đấu', fights: 'Số trận', finishRate: 'Tỷ lệ kết thúc', attendance: 'Khán giả', profit: 'Lợi nhuận', events: 'Sự kiện', appearances: 'Lượt thi đấu', wins: 'Thắng', fighterPay: 'Thù lao võ sĩ', liabilities: 'Nợ phải trả', dateWon: 'Ngày giành đai', reignDays: 'Số ngày giữ đai', defenses: 'Bảo vệ đai', tournament: 'Giải đấu', type: 'Loại', winner: 'Người thắng', rating: 'Điểm TB' }, metrics: { wins: 'Số trận thắng', winPercentage: 'Tỷ lệ thắng', koWins: 'Thắng KO/TKO', submissionWins: 'Thắng khóa siết', currentStreak: 'Chuỗi thắng hiện tại', longestStreak: 'Chuỗi thắng dài nhất', titleDefenses: 'Bảo vệ đai', trackedEarnings: 'Thu nhập đã ghi', strikingAccuracy: 'Độ chính xác đánh đứng', takedownAccuracy: 'Độ chính xác quật ngã', knockdowns: 'Đánh ngã', controlTime: 'Thời gian kiểm soát' }, fightMetrics: { rating: 'Điểm trình diễn', fastestFinish: 'Kết thúc nhanh nhất', longestFight: 'Trận dài nhất', knockdowns: 'Đánh ngã', significantStrikes: 'Đòn đáng kể', takedowns: 'Quật ngã', controlTime: 'Thời gian kiểm soát' }, tournamentTypes: { domestic_gp: 'Grand Prix quốc nội', champions_cup: 'Champions Cup', challenge_cup: 'Challenge Cup' }
  },
  fighterDetail: {
    notFound: 'Không tìm thấy võ sĩ.', tabs: { overview: 'Tổng quan', achievements: 'Thành tích', storylines: 'Cốt truyện', contract: 'Hợp đồng', fights: 'Nhật ký đấu', statistics: 'Thống kê', timeline: 'Dòng thời gian' }, sectionsLabel: 'Các phần chi tiết võ sĩ', years: '{{count}} tuổi', beltAlt: 'Đai vô địch {{type}} hạng {{weightClass}} do {{name}} nắm giữ', interimChampion: 'Nhà vô địch tạm thời', undisputedChampion: 'Nhà vô địch tuyệt đối', record: 'Thành tích', style: 'Phong cách', status: 'Trạng thái', physicalProfile: 'Hồ sơ thể chất', height: 'Chiều cao', fightWeight: 'Cân nặng thi đấu', walkAroundWeight: 'Cân nặng thường ngày', weightCut: 'Mức cắt cân', attributes: 'Thuộc tính', attribute: { striking: 'Đánh đứng', grappling: 'Địa chiến', wrestling: 'Vật', submissions: 'Khóa siết', cardio: 'Thể lực', chin: 'Khả năng chịu đòn', power: 'Sức mạnh', speed: 'Tốc độ', defense: 'Phòng thủ', fightIq: 'Tư duy thi đấu', toughness: 'Độ lì đòn' }, careerSummary: 'Tổng kết sự nghiệp', titleFights: 'Trận tranh đai', currentStreak: 'Chuỗi thắng hiện tại', bestStreak: 'Chuỗi thắng tốt nhất', averagePerformance: 'Màn trình diễn TB', koWins: 'Thắng KO/TKO', submissionWins: 'Thắng khóa siết', decisionWins: 'Thắng bằng điểm', decisionLosses: 'Thua bằng điểm', fourManGp: 'GP 4 người', eightManGp: 'GP 8 người', gpFinals: 'Chung kết GP', gpRecord: 'Thành tích GP', titleShot: 'Cơ hội tranh đai', pending: 'Đang chờ', achievements: 'Thành tích', achievementsDescription: 'Danh hiệu, kết quả Grand Prix, giải thưởng năm và cột mốc giải đấu.', noAchievements: 'Chưa có thành tích. Hãy thắng trận tranh đai, Grand Prix hoặc giải thưởng năm để bổ sung mục này.', achievementCategory: { titles: 'Danh hiệu', grandPrix: 'Grand Prix', awards: 'Giải thưởng', milestones: 'Cột mốc' }, activeStorylines: 'Cốt truyện đang diễn ra', storylinesDescription: 'Kình địch, câu chuyện tranh đai, tranh chấp và các diễn biến khác liên quan đến võ sĩ này.', noStorylines: 'Không có cốt truyện đang hoạt động.', intensity: 'Cường độ {{value}}/3', started: 'Bắt đầu {{date}}', active: 'Đang hoạt động', expires: 'Hết hạn {{date}}', socialActivity: 'Hoạt động xã hội', socialDescription: 'Tin, bài viết, bài đăng và thảo luận liên quan đến {{name}}.', noSocialActivity: 'Chưa có hoạt động xã hội.', contractExtension: 'Hợp đồng & Gia hạn', negotiateContract: 'Đàm phán hợp đồng', release: 'Thanh lý võ sĩ', releaseConfirm: 'Bạn có chắc muốn thanh lý {{name}}?', currentDeal: 'Hợp đồng hiện tại: {{pay}} tiền thi đấu, {{bonus}} thưởng thắng', fightsRemaining: 'Còn {{count}} trận · Kết thúc {{date}}', championExpired: 'Hợp đồng nhà vô địch đã hết hạn. Gia hạn ngay hoặc bỏ trống đai.', offerAccepted: 'Đã chấp nhận đề nghị', offerRejected: 'Đã từ chối đề nghị', counterOffer: 'Đề nghị ngược', counterOfferTerms: '{{pay}} tiền thi đấu · {{bonus}} thưởng thắng · {{count}} trận · hết hạn {{date}}', acceptCounter: 'Chấp nhận đề nghị ngược', expected: 'Kỳ vọng: {{pay}} tiền thi đấu · {{bonus}} thưởng thắng · {{interest}}', payPerFight: 'Tiền mỗi trận (USD)', winBonus: 'Thưởng chiến thắng (USD)', fights: 'Số trận', offerExtension: 'Đề nghị gia hạn', offerContract: 'Đề nghị hợp đồng', respondCounter: 'Hãy phản hồi đề nghị ngược hiện tại trước khi gửi đề nghị khác.', fightLog: 'Nhật ký đấu', date: 'Ngày', event: 'Sự kiện', opponent: 'Đối thủ', result: 'Kết quả', method: 'Phương thức', round: 'Hiệp', unknown: 'Không rõ', draw: 'Hòa', win: 'Thắng', loss: 'Thua', viewFight: 'Xem chi tiết trận với {{opponent}} ngày {{date}}', versus: 'đấu {{name}}', noFights: 'Chưa có trận lưu trữ.', legacyHistory: 'Lịch sử cũ', careerTimeline: 'Dòng thời gian sự nghiệp', noTimeline: 'Chưa có mốc sự nghiệp.', career: { retired: 'Đã giải nghệ', retiredOn: 'Giải nghệ ngày {{date}}', retirementAge: 'Tuổi giải nghệ {{age}}', reason: 'Lý do: {{reason}}', reasons: { age: 'Tuổi tác', injuries: 'Chấn thương tích lũy', decline: 'Suy giảm năng lực thi đấu', inactivity: 'Không thi đấu kéo dài' }, hallOfFame: 'Đại sảnh Danh vọng · Vinh danh năm {{year}} · Điểm di sản {{score}}' }, statistics: { eyebrow: 'Dữ liệu sự nghiệp', title: 'Thống kê võ sĩ', description: 'Thống kê sự nghiệp và kỹ thuật đã lưu của {{name}}.', trackedSince: 'Bắt đầu ghi chính xác thu nhập và thứ hạng từ {{date}}.', unknown: 'Dữ liệu cũ vẫn hiển thị, nhưng giá trị không có sẽ không được ước tính.', empty: 'Chưa có dữ liệu được ghi nhận.', showMore: 'Xem thêm', career: { fights: 'Số trận', wins: 'Thắng', losses: 'Thua', draws: 'Hòa', winRate: 'Tỷ lệ thắng', koWins: 'Thắng KO/TKO', submissionWins: 'Thắng khóa siết', decisionWins: 'Thắng bằng điểm', currentStreak: 'Chuỗi hiện tại', longestStreak: 'Chuỗi dài nhất', titleFights: 'Trận tranh đai', titleWins: 'Lần giành đai', titleDefenses: 'Lần bảo vệ đai', trackedEarnings: 'Thu nhập đã ghi', trackedCount: '{{count}} trận có dữ liệu' }, striking: { title: 'Đánh đứng', total: 'Chỉ số', perFight: 'Mỗi trận', per15Min: 'Mỗi 15 phút', accuracy: 'Chính xác', landed: 'Tổng', attempted: 'Ra đòn', significant: 'Đòn đáng kể', head: 'Đòn vào đầu', body: 'Đòn vào thân', leg: 'Đòn vào chân' }, grappling: { title: 'Địa chiến', total: 'Chỉ số', perFight: 'Mỗi trận', per15Min: 'Mỗi 15 phút', accuracy: 'Chính xác', takedowns: 'Quật ngã', submissionAttempts: 'Lần thử khóa siết', reversals: 'Đảo vị trí', control: 'Thời gian kiểm soát', knockdowns: 'Đánh ngã' }, perFight: { title: 'Thống kê từng trận', date: 'Ngày', event: 'Sự kiện', opponent: 'Đối thủ', result: 'Kết quả', method: 'Phương thức', round: 'Hiệp / thời gian', time: 'Thời gian', elapsed: 'Tổng thời gian', rating: 'Điểm', payout: 'Thu nhập' }, rankingHistory: { title: 'Lịch sử thứ hạng', date: 'Ngày', scope: 'Phạm vi', promotion: 'Giải đấu', division: 'Hạng cân', previous: 'Trước', current: 'Sau', unranked: 'Chưa xếp hạng', world: 'Thế giới', promotionScope: 'Giải đấu' } }, editor: { edit: 'Chỉnh sửa hồ sơ', title: 'Trình chỉnh sửa võ sĩ', save: 'Lưu thay đổi', cancel: 'Hủy', profile: 'Hồ sơ', physical: 'Thể chất', management: 'Quản lý', firstName: 'Tên', lastName: 'Họ', nickname: 'Biệt danh', age: 'Tuổi', nationality: 'Quốc tịch', weightClass: 'Hạng cân', style: 'Phong cách', potential: 'Tiềm năng', popularity: 'Độ nổi tiếng', morale: 'Tinh thần', momentum: 'Đà phong độ', fatigue: 'Mệt mỏi', error: 'Không thể lưu thay đổi: {{reason}}', errors: { fighterNotFound: 'Không tìm thấy võ sĩ.', invalidName: 'Hãy nhập tên hợp lệ, tối đa 50 ký tự.', invalidNationality: 'Hãy nhập quốc tịch tối đa 50 ký tự.', invalidAge: 'Tuổi phải từ 18 đến 45.', invalidWeightClass: 'Hãy chọn hạng cân hợp lệ.', invalidStyle: 'Hãy chọn phong cách hợp lệ.', invalidAttributes: 'Thuộc tính phải là số từ 10 đến 100.', invalidPotential: 'Tiềm năng phải là số nguyên từ 0 đến 100.', invalidPopularity: 'Độ nổi tiếng phải là số nguyên từ 0 đến 100.', invalidMorale: 'Tinh thần phải là số nguyên từ 0 đến 100.', invalidMomentum: 'Đà phong độ phải là số nguyên từ 0 đến 100.', invalidFatigue: 'Mệt mỏi phải là số nguyên từ 0 đến 100.', invalidPhysicalProfile: 'Chỉ số thể chất phải phù hợp hạng cân và cân nặng thường ngày phải lớn hơn cân nặng thi đấu.', weightClassTitle: 'Võ sĩ đang giữ đai không thể đổi hạng cân.', weightClassBooked: 'Võ sĩ đã có lịch đấu tương lai không thể đổi hạng cân.', weightClassTournament: 'Võ sĩ đang tham gia Grand Prix đã lên kế hoạch hoặc đang diễn ra không thể đổi hạng cân.', weightClassTitleShot: 'Võ sĩ đang được quyền tranh đai không thể đổi hạng cân.' } }
  },
  personality: {
    title: 'Tính cách',
    explain: 'Tính cách ảnh hưởng game thế nào',
    description: 'Đặc điểm tính cách định hình sự cố hậu trường, áp lực đàm phán và quyết định của promoter. Chúng không trực tiếp thay đổi chỉ số, thứ hạng hay tỷ lệ thắng.',
    traits: { professional: 'Chuyên nghiệp', trashTalker: 'Khẩu chiến', diva: 'Ngôi sao khó chiều', loyal: 'Trung thành', mercenary: 'Thực dụng', riskTaker: 'Ưa mạo hiểm', hotHead: 'Nóng tính', companyFighter: 'Vì tập thể' }
  },
  objectives: {
    title: 'Mục tiêu mùa {{year}}',
    description: 'Hoàn thành các mục tiêu thi đấu, giải trí và kinh doanh trước khi mùa giải kết thúc.',
    completed: 'Hoàn thành',
    progress: '{{progress}} / {{target}}',
    kinds: { activeChampion: 'Duy trì nhà vô địch hoạt động', titleFights: 'Xếp các trận tranh đai', prospectTopFive: 'Phát triển tài năng trẻ vào top 5', profitableGrandPrix: 'Tổ chức Grand Prix có lãi', strongRivalry: 'Xây dựng mối thù địch mạnh', awardCandidate: 'Tạo ứng viên giải thưởng', profit: 'Đạt mục tiêu lợi nhuận', fanbaseGrowth: 'Tăng lượng người hâm mộ' }
  },
  socialHub: {
  ...
  inbox: {
    ...
    drama: {
      backToList: 'Quay lại danh sách quyết định',
      decisionRequired: 'Cần đưa ra quyết định',
      description: 'Chọn một cách xử lý. Các hậu quả liệt kê cho biết phần nào của giải đấu có thể thay đổi.',
      selectDecision: 'Chọn một tình huống hậu trường để xem các phương án.',
      chooseResponse: 'Chọn phương án này',
      consequences: 'Hậu quả có thể xảy ra',
      risk: { label: 'Rủi ro', low: 'Thấp', medium: 'Trung bình', high: 'Cao' },
      incident: {
        weightCut: 'Vấn đề cắt cân',
        campInjury: 'Lo ngại chấn thương trong trại tập',
        trashTalk: 'Khẩu chiến leo thang',
        pressAltercation: 'Xô xát tại sự kiện truyền thông',
        payDemand: 'Đòi tăng thù lao phút chót',
        shortNoticeRefusal: 'Từ chối thi đấu gấp',
        titlePictureComplaint: 'Phàn nàn về cuộc đua tranh đai'
      },
      response: {
        acceptCatchweight: 'Chấp nhận trận đấu lệch cân',
        fineFighter: 'Phạt tiền võ sĩ',
        replaceOrCancel: 'Thay võ sĩ hoặc hủy trận',
        restAndContinue: 'Giảm tải trại tập và tiếp tục',
        amplify: 'Đẩy mạnh tranh cãi',
        deescalate: 'Công khai hạ nhiệt',
        fineBoth: 'Phạt tiền cả hai võ sĩ',
        useForHype: 'Dùng vụ xô xát để quảng bá',
        improveTerms: 'Cải thiện điều khoản tài chính',
        holdLine: 'Giữ nguyên điều khoản',
        respectRefusal: 'Tôn trọng quyết định từ chối',
        applyPressure: 'Gây áp lực để võ sĩ nhận trận',
        promiseEliminator: 'Hứa một trận loại tranh đai',
        rejectDemand: 'Từ chối yêu cầu'
      },
      consequence: {
        hype: 'Độ nóng của trận đấu có thể thay đổi',
        opponentMorale: 'Tinh thần đối thủ có thể thay đổi',
        money: 'Tiền mặt của giải đấu có thể thay đổi',
        fighterMorale: 'Tinh thần võ sĩ có thể thay đổi',
        booking: 'Trận đã xếp có thể bị gỡ',
        fatigue: 'Mức mệt mỏi của võ sĩ có thể tăng',
        rivalry: 'Một mối thù địch có thể hình thành',
        morale: 'Tinh thần võ sĩ có thể thay đổi',
        reputation: 'Danh tiếng giải đấu có thể thay đổi'
      }
    }
  },
  calendar: {
  ...
  seasonReview: {
    ...
    description: 'Điểm hằng năm tổng hợp mức hoàn thành mục tiêu và tình trạng giải đấu khi kết thúc năm.',
    year: 'Mùa {{year}}',
    completed: 'Hoàn thành {{completed}} / {{total}} mục tiêu',
    finalFunds: 'Ngân quỹ cuối mùa: {{amount}}',
    topIncident: 'Sự cố tiêu biểu: {{type}}'
  },
  dramaTimeline: {
    title: 'Dòng thời gian drama',
    description: 'Xem lại sự cố đã xử lý, quyết định, lý do và hậu quả được ghi nhận.',
    severity: 'Lọc theo mức độ',
    allSeverities: 'Mọi mức độ',
    type: 'Lọc theo loại sự cố',
    allTypes: 'Mọi loại sự cố',
    event: 'Lọc theo sự kiện',
    allEvents: 'Mọi sự kiện',
    fighter: 'Lọc theo võ sĩ',
    allFighters: 'Mọi võ sĩ',
    response: 'Phương án: {{response}}',
    rationale: 'Lý do của Observer: {{rationale}}',
    rationaleFactors: { identity: 'Bản sắc nhà tổ chức', booking: 'Ổn định lịch đấu', cashSafety: 'Bảo toàn tiền mặt', eventImportance: 'Tầm quan trọng sự kiện', fighterDevelopment: 'Phát triển võ sĩ' },
    consequences: { money: 'Tiền mặt', reputation: 'Danh tiếng', fanbase: 'Người hâm mộ', morale: 'Tinh thần', popularity: 'Độ nổi tiếng', fatigue: 'Mệt mỏi', socialHype: 'Sức nóng mạng xã hội', rivalry: 'Mối thù địch', injury: 'Chấn thương', booking: 'Lịch đấu' }
  },
  historyStats: {
  ...
  generated: {
    objectives: { reward: 'Hoàn thành mục tiêu mùa giải: {{kind}}' },
    drama: { decisionTitle: 'Quyết định hậu trường', decisionBody: '{{fighter}}: ban tổ chức đã chọn phương án {{response}}.', unknownFighter: 'Võ sĩ', rivalryDescription: 'Một mối thù địch căng thẳng đang hình thành.' },
