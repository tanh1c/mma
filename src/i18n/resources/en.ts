const en = {
  ...
  navigation: {
    ...
    promotionFinances: 'Promotion Finances',
    rankings: 'Rankings',
  ...
  leagues: {
    title: 'World Leagues', playerControlled: 'Player managed', aiControlled: 'AI managed', domesticChampion: 'Domestic Champion', domesticRankings: 'Domestic Rankings', championsCupQualification: 'Champions Cup Qualification', challengeCupQualification: 'Challenge Cup Qualification', internationalChampions: 'International Champions', noChampion: 'Vacant'
  },
  contractMarket: {
    eyebrow: 'Competition', title: 'Contract Market', description: 'List contracted fighters and submit sealed offers during the seasonal transfer window.', budget: 'Contract budget', mode: 'Financial mode', viewFinances: 'View Promotion Finances', sectionsLabel: 'Contract Market sections', windowStatus: 'Window status', opens: 'Opens', closes: 'Closes', daysRemaining: '{{count}} days remaining', openHelp: 'The market is open. Contract activity must use this page.', closedHelp: 'Offers and listings are locked until the next window.', unknownFighter: 'Unknown fighter', freeAgent: 'Free agent', selectFighter: 'Select fighter', tabs: { available: 'Available', listings: 'My Listings', incoming: 'Incoming Offers', offers: 'My Offers', history: 'History' }, status: { scheduled: 'Scheduled', open: 'Open', resolving: 'Resolving', closed: 'Closed' }, interested: '{{count}} interested promotions', competition: 'Competition: {{level}}', minimumFee: 'Minimum fee {{amount}}', minimumFeeLabel: 'Minimum fee', expiring: 'Contract ends {{date}}', affordable: 'Affordable', unaffordable: 'Insufficient funds', transferFee: 'Transfer fee', payPerFight: 'Pay per fight', winBonus: 'Win bonus', fights: 'Fights', submit: 'Submit sealed offer', revise: 'Revise offer', offerSubmitted: 'Offer submitted.', listFighter: 'List a fighter', list: 'List fighter', listed: 'Fighter listed.', withdraw: 'Withdraw', withdrawn: 'Withdrawn.', accept: 'Accept fee', reject: 'Reject fee', accepted: 'Fee accepted.', rejected: 'Fee rejected.', noItems: 'No records in this section.', marketRequired: 'Contract activity is handled through the open market.', reasons: { submitted: 'Offer submitted', sellerAccepted: 'Seller accepted the fee', sellerRejected: 'Seller rejected the fee', sellerNoResponse: 'Seller did not approve the fee', sellerFeeTooLow: 'Transfer fee was too low', betterExpectedPay: 'Superior expected pay', betterPrestige: 'Stronger promotion prestige', betterTitleOpportunity: 'Better title opportunity', loyalty: 'Loyalty to current promotion', outbid: 'Another package was preferred', ownershipChanged: 'Fighter ownership changed', windowNotOpen: 'The Contract Market is not open', insufficientCash: 'Buyer no longer had enough cash', internationalCompetitionActive: 'Fighter remained in an active international competition', invalidTerms: 'Enter valid whole-number contract terms', noEligibleOffer: 'No eligible offer remained', invalid: 'Package became invalid' }
  },
  promotionFinances: {
    eyebrow: 'Management', title: 'Promotion Finances', description: 'Exact operating finances for every promotion.', selectPromotion: 'Promotion', cash: 'Cash balance', debtLimit: 'Debt limit', headroom: 'Remaining headroom', liabilities: 'Outstanding liabilities', runway: 'Estimated runway', months: '{{count}} months', mode: 'Financial mode', modes: { growth: 'Growth', stable: 'Stable', cautious: 'Cautious', recovery: 'Recovery' }, contractBudget: 'Contract budget', monthlyIncome: 'Monthly income', monthlyExpenses: 'Monthly expenses', monthlyNet: 'Monthly net', sponsorIncome: 'Sponsor income', mediaIncome: 'Media income', operatingCost: 'Operating cost', rosterRetainer: 'Roster retainer', brandSpend: 'Brand investment', recentEvent: 'Recent event profit/loss', ledger: 'Promotion ledger', ledgerCaption: 'Promotion transactions in settlement order', brandHistory: 'Brand investment history', date: 'Date', category: 'Category', transactionDescription: 'Description', amount: 'Amount', balance: 'Balance after', investTitle: 'Invest in brand', investAmount: 'Investment amount', projectedEffect: '+{{fanbase}} fans, +{{reputation}} reputation', invest: 'Invest', rivalReadOnly: 'Rival finances are read-only.', noEntries: 'No transactions yet.', reasons: { invalidAmount: 'Enter a whole amount of at least {{minimum}}.', recoveryMode: 'Brand investment is blocked during recovery.', outstandingLiabilities: 'Pay outstanding liabilities before discretionary spending.', debtLimit: 'This would cross the debt limit.', requiredReserve: 'This would use required operating reserves.', success: 'Brand investment completed.' }, categories: { eventGate: 'Event gate', eventMedia: 'Event media', eventSponsor: 'Event sponsor', fighterPurse: 'Fighter purse', winBonus: 'Win bonus', venue: 'Venue', eventMarketing: 'Event marketing', monthlySponsor: 'Monthly sponsor', monthlyMedia: 'Monthly media', operatingCost: 'Operating cost', rosterRetainer: 'Roster retainer', liabilityPayment: 'Liability payment', brandInvestment: 'Brand investment', transferFee: 'Transfer fee', objectiveReward: 'Objective reward', drama: 'Drama', legacy: 'Legacy finance' }
  },
  tournaments: {
    eyebrow: 'Competition format', title: 'Grand Prix Tournaments', description: 'Organize 4-man and 8-man elimination brackets to determine number one contenders.', domestic: 'Domestic', international: 'International', create: 'Create Grand Prix', newTitle: 'New Grand Prix Tournament', close: 'Close tournament form', name: 'Tournament Name', weightClass: 'Weight Class', format: 'Format', fourMan: '4-Man Grand Prix', eightMan: '8-Man Grand Prix', titleShot: 'Promise Undisputed Title Shot', titleShotHelp: 'Grand Prix winner is owed an undisputed title fight.', selectParticipants: 'Select {{count}} Participants', selected: '{{selected}} / {{count}} Selected', eligibility: 'Only signed, healthy, unbooked fighters in this division are eligible. Seeded by ELO ranking score; OVR breaks ranking ties.', noEligible: 'No eligible fighters in the {{weightClass}} division. Sign new fighters or free up booked ones.', participant: 'Participant', reserve: 'Reserve ({{selected}}/{{count}})', cancel: 'Cancel', createTournament: 'Create Tournament', exactParticipants: 'Please select exactly {{count}} participants.', list: 'Tournament List', filters: { all: 'All', active: 'Active', completed: 'Completed', cancelled: 'Cancelled' }, noMatches: 'No tournaments found matching filter.', winner: 'Winner: {{name}}', created: 'Created: {{date}}', bracket: 'Bracket & Details', statusDivision: 'Status: {{status}} · Division: {{division}}', scheduleQuarterfinals: 'Schedule Quarterfinals', scheduleSemifinals: 'Schedule Semifinals', scheduleFinal: 'Schedule Final', cancelConfirm: 'Cancel this tournament? Scheduled fights will be removed.', cancelGp: 'Cancel GP', viewStats: 'View Fight Stats →', statsAfterEvent: 'Stats available after event.', quarterfinals: 'Quarterfinals', quarterfinal: 'Quarterfinal {{number}}', semifinals: 'Semifinals', semifinal: 'Semifinal Match {{number}}', final: 'Final', grandPrixFinal: 'Grand Prix Final', championshipFinal: 'Championship Final', linkedEvent: 'Linked Event', pending: 'TBD', replacementReserve: 'Reserve', gpStatus: 'GP status: {{status}}', earliestRetry: 'Earliest retry: {{date}}', scheduleRound: 'Schedule {{round}}', reserves: 'Reserve Fighters', noReserves: 'No reserves designated.', ready: 'Ready', titleShotPromised: 'Title Shot Promised', titleShotDescription: 'Winner earns a guaranteed undisputed title shot against the division champion.', history: 'Tournament History & Logs', selectPrompt: 'Select a tournament from the list or create a new one to view brackets and details.', scheduleTitle: 'Schedule {{round}}', scheduleDescription: 'Select an upcoming event to host these tournament fights. They will be appended to the event matchups.', noEvents: 'No upcoming events booked!', noEventsHint: 'Create an event using the Book Event menu first.', chooseEvent: 'Choose Event', selectEvent: '-- Select Event --', confirmScheduling: 'Confirm Scheduling', round: { quarterfinal: 'Quarterfinal Matches', semifinal: 'Semifinal Matches', final: 'Grand Prix Final' }
  },
  statsBoard: {
    eyebrow: 'Records', title: 'Stats Board', description: 'Sortable records across fighters, fights, events, promotions, titles, and tournaments.', sectionsLabel: 'Statistics domains', showMore: 'Show more', empty: 'No records match these filters.', international: 'International', tabs: { fighters: 'Fighters', fights: 'Fights', events: 'Events', promotions: 'Promotions', titles: 'Titles', tournaments: 'Tournaments' }, filters: { period: 'Period', scope: 'Scope', division: 'Division', allTime: 'All time', currentSeason: 'Current season', world: 'World', international: 'International', allDivisions: 'All divisions' }, columns: { record: 'Record', fighter: 'Fighter', division: 'Division', value: 'Value', sample: 'Sample', fight: 'Fight', event: 'Event', date: 'Date', promotion: 'Promotion', fights: 'Fights', finishRate: 'Finish rate', attendance: 'Attendance', profit: 'Profit', events: 'Events', appearances: 'Appearances', wins: 'Wins', fighterPay: 'Fighter pay', liabilities: 'Liabilities', dateWon: 'Date won', reignDays: 'Reign days', defenses: 'Defenses', tournament: 'Tournament', type: 'Type', winner: 'Winner', rating: 'Avg. rating' }, metrics: { wins: 'Wins', winPercentage: 'Win percentage', koWins: 'KO/TKO wins', submissionWins: 'Submission wins', currentStreak: 'Current win streak', longestStreak: 'Longest win streak', titleDefenses: 'Title defenses', trackedEarnings: 'Tracked earnings', strikingAccuracy: 'Striking accuracy', takedownAccuracy: 'Takedown accuracy', knockdowns: 'Knockdowns', controlTime: 'Control time' }, fightMetrics: { rating: 'Performance rating', fastestFinish: 'Fastest finish', longestFight: 'Longest fight', knockdowns: 'Knockdowns', significantStrikes: 'Significant strikes', takedowns: 'Takedowns', controlTime: 'Control time' }, tournamentTypes: { domestic_gp: 'Domestic Grand Prix', champions_cup: 'Champions Cup', challenge_cup: 'Challenge Cup' }
  },
  fighterDetail: {
    notFound: 'Fighter not found.', tabs: { overview: 'Overview', achievements: 'Achievements', storylines: 'Storylines', contract: 'Contract', fights: 'Fight Log', statistics: 'Statistics', timeline: 'Timeline' }, sectionsLabel: 'Fighter detail sections', years: '{{count}} years', beltAlt: '{{weightClass}} {{type}} championship belt held by {{name}}', interimChampion: 'Interim Champion', undisputedChampion: 'Undisputed Champion', record: 'Record', style: 'Style', status: 'Status', physicalProfile: 'Physical Profile', height: 'Height', fightWeight: 'Fight Weight', walkAroundWeight: 'Walk-around Weight', weightCut: 'Weight Cut', attributes: 'Attributes', attribute: { striking: 'Striking', grappling: 'Grappling', wrestling: 'Wrestling', submissions: 'Submissions', cardio: 'Cardio', chin: 'Chin', power: 'Power', speed: 'Speed', defense: 'Defense', fightIq: 'Fight IQ', toughness: 'Toughness' }, careerSummary: 'Career Summary', titleFights: 'Title Fights', currentStreak: 'Current Streak', bestStreak: 'Best Streak', averagePerformance: 'Avg. Performance', koWins: 'KO/TKO Wins', submissionWins: 'Submission Wins', decisionWins: 'Decision Wins', decisionLosses: 'Decision Losses', fourManGp: '4-Man GP', eightManGp: '8-Man GP', gpFinals: 'GP Finals', gpRecord: 'GP Record', titleShot: 'Title Shot', pending: 'Pending', achievements: 'Achievements', achievementsDescription: 'Titles, Grand Prix results, annual awards, and promotion milestones.', noAchievements: 'No achievements yet. Win title fights, Grand Prix tournaments, or yearly awards to fill this section.', achievementCategory: { titles: 'Titles', grandPrix: 'Grand Prix', awards: 'Awards', milestones: 'Milestones' }, activeStorylines: 'Active Storylines', storylinesDescription: 'Rivalries, title narratives, disputes, and other live drama involving this fighter.', noStorylines: 'No active storylines.', intensity: 'Intensity {{value}}/3', started: 'Started {{date}}', active: 'Active', expires: 'Expires {{date}}', socialActivity: 'Social activity', socialDescription: 'News, articles, posts, and threads involving {{name}}.', noSocialActivity: 'No social activity yet.', contractExtension: 'Contract & Extension', negotiateContract: 'Negotiate Contract', release: 'Release Fighter', releaseConfirm: 'Are you sure you want to release {{name}}?', currentDeal: 'Current deal: {{pay}} to show, {{bonus}} to win', fightsRemaining: 'Fights remaining: {{count}} · Ends {{date}}', championExpired: 'Champion contract expired. Renew immediately or vacate the title.', offerAccepted: 'Offer Accepted', offerRejected: 'Offer Rejected', counterOffer: 'Counter-offer', counterOfferTerms: '{{pay}} to show · {{bonus}} to win · {{count}} fights · expires {{date}}', acceptCounter: 'Accept counter-offer', expected: 'Expected: {{pay}} to show · {{bonus}} to win · {{interest}}', payPerFight: 'Pay per Fight (USD)', winBonus: 'Win Bonus (USD)', fights: 'Fights', offerExtension: 'Offer Extension', offerContract: 'Offer Contract', respondCounter: 'Respond to the current counter-offer before making another offer.', fightLog: 'Fight Log', date: 'Date', event: 'Event', opponent: 'Opponent', result: 'Result', method: 'Method', round: 'Round', unknown: 'Unknown', draw: 'Draw', win: 'Win', loss: 'Loss', viewFight: 'View fight details against {{opponent}} on {{date}}', versus: 'vs. {{name}}', noFights: 'No archived fights yet.', legacyHistory: 'Legacy history', careerTimeline: 'Career Timeline', noTimeline: 'No career timeline entries yet.', career: { retired: 'Retired', retiredOn: 'Retired on {{date}}', retirementAge: 'Retirement age {{age}}', reason: 'Reason: {{reason}}', reasons: { age: 'Age', injuries: 'Accumulated injuries', decline: 'Competitive decline', inactivity: 'Inactivity' }, hallOfFame: 'Hall of Fame · Inducted {{year}} · Legacy score {{score}}' }, statistics: { eyebrow: 'Career data', title: 'Fighter Statistics', description: 'Archived career and technical statistics for {{name}}.', trackedSince: 'Exact payout and ranking tracking began {{date}}.', unknown: 'Earlier records remain visible, but unavailable values are not estimated.', empty: 'No tracked records yet.', showMore: 'Show more', career: { fights: 'Fights', wins: 'Wins', losses: 'Losses', draws: 'Draws', winRate: 'Win rate', koWins: 'KO/TKO wins', submissionWins: 'Submission wins', decisionWins: 'Decision wins', currentStreak: 'Current streak', longestStreak: 'Longest streak', titleFights: 'Title fights', titleWins: 'Title wins', titleDefenses: 'Title defenses', trackedEarnings: 'Tracked earnings', trackedCount: '{{count}} tracked fights' }, striking: { title: 'Striking', total: 'Metric', perFight: 'Per fight', per15Min: 'Per 15 min', accuracy: 'Accuracy', landed: 'Total', attempted: 'Attempted', significant: 'Significant strikes', head: 'Head strikes', body: 'Body strikes', leg: 'Leg strikes' }, grappling: { title: 'Grappling', total: 'Metric', perFight: 'Per fight', per15Min: 'Per 15 min', accuracy: 'Accuracy', takedowns: 'Takedowns', submissionAttempts: 'Submission attempts', reversals: 'Reversals', control: 'Control time', knockdowns: 'Knockdowns' }, perFight: { title: 'Per-fight statistics', date: 'Date', event: 'Event', opponent: 'Opponent', result: 'Result', method: 'Method', round: 'Round / time', time: 'Time', elapsed: 'Elapsed', rating: 'Rating', payout: 'Payout' }, rankingHistory: { title: 'Ranking history', date: 'Date', scope: 'Scope', promotion: 'Promotion', division: 'Division', previous: 'Previous', current: 'Current', unranked: 'Unranked', world: 'World', promotionScope: 'Promotion' } }, editor: { edit: 'Edit Profile', title: 'Fighter Editor', save: 'Save Changes', cancel: 'Cancel', profile: 'Profile', physical: 'Physical', management: 'Management', firstName: 'First Name', lastName: 'Last Name', nickname: 'Nickname', age: 'Age', nationality: 'Nationality', weightClass: 'Weight Class', style: 'Style', potential: 'Potential', popularity: 'Popularity', morale: 'Morale', momentum: 'Momentum', fatigue: 'Fatigue', error: 'Changes were not saved: {{reason}}', errors: { fighterNotFound: 'Fighter not found.', invalidName: 'Enter valid names no longer than 50 characters.', invalidNationality: 'Enter a nationality no longer than 50 characters.', invalidAge: 'Age must be between 18 and 45.', invalidWeightClass: 'Select a valid weight class.', invalidStyle: 'Select a valid style.', invalidAttributes: 'Attributes must be numbers from 10 to 100.', invalidPotential: 'Potential must be a whole number from 0 to 100.', invalidPopularity: 'Popularity must be a whole number from 0 to 100.', invalidMorale: 'Morale must be a whole number from 0 to 100.', invalidMomentum: 'Momentum must be a whole number from 0 to 100.', invalidFatigue: 'Fatigue must be a whole number from 0 to 100.', invalidPhysicalProfile: 'Physical values must fit the selected weight class and walk-around weight must exceed fight weight.', weightClassTitle: 'A current title holder cannot change weight class.', weightClassBooked: 'A fighter booked for a future event cannot change weight class.', weightClassTournament: 'A fighter in a planned or active Grand Prix cannot change weight class.', weightClassTitleShot: 'A fighter owed a title shot cannot change weight class.' } }
  },
  personality: {
    title: 'Personality',
    explain: 'How personality affects the game',
    description: 'Traits shape backstage incidents, negotiation pressure, and promoter decisions. They do not directly change ratings, rankings, or fight odds.',
    traits: { professional: 'Professional', trashTalker: 'Trash talker', diva: 'Diva', loyal: 'Loyal', mercenary: 'Mercenary', riskTaker: 'Risk taker', hotHead: 'Hot head', companyFighter: 'Company fighter' }
  },
  objectives: {
    title: '{{year}} Season Objectives',
    description: 'Complete sporting, entertainment, and business goals before the season ends.',
    completed: 'Completed',
    progress: '{{progress}} / {{target}}',
    kinds: { activeChampion: 'Maintain an active champion', titleFights: 'Book title fights', prospectTopFive: 'Develop a top-five prospect', profitableGrandPrix: 'Run a profitable Grand Prix', strongRivalry: 'Build a strong rivalry', awardCandidate: 'Create an award candidate', profit: 'Reach the profit target', fanbaseGrowth: 'Grow the fanbase' }
  },
  socialHub: {
  ...
  inbox: {
    ...
    drama: {
      backToList: 'Back to decisions',
      decisionRequired: 'Decision required',
      description: 'Choose a response. The listed consequences show which parts of the promotion may change.',
      selectDecision: 'Select a drama decision to review its options.',
      chooseResponse: 'Choose this response',
      consequences: 'Possible consequences',
      risk: { label: 'Risk', low: 'Low', medium: 'Medium', high: 'High' },
      incident: {
        weightCut: 'Weight-cut problem',
        campInjury: 'Camp injury concern',
        trashTalk: 'Trash-talk escalation',
        pressAltercation: 'Press-event altercation',
        payDemand: 'Late pay demand',
        shortNoticeRefusal: 'Short-notice refusal',
        titlePictureComplaint: 'Title-picture complaint'
      },
      response: {
        acceptCatchweight: 'Accept a catchweight bout',
        fineFighter: 'Fine the fighter',
        replaceOrCancel: 'Replace the fighter or cancel the bout',
        restAndContinue: 'Reduce camp load and continue',
        amplify: 'Amplify the dispute',
        deescalate: 'De-escalate publicly',
        fineBoth: 'Fine both fighters',
        useForHype: 'Use the altercation for promotion',
        improveTerms: 'Improve the financial terms',
        holdLine: 'Hold the current terms',
        respectRefusal: 'Respect the refusal',
        applyPressure: 'Pressure the fighter to accept',
        promiseEliminator: 'Promise a title eliminator',
        rejectDemand: 'Reject the demand'
      },
      consequence: {
        hype: 'Fight hype may change',
        opponentMorale: 'Opponent morale may change',
        money: 'Promotion cash may change',
        fighterMorale: 'Fighter morale may change',
        booking: 'The booked fight may be removed',
        fatigue: 'Fighter fatigue may increase',
        rivalry: 'A rivalry may develop',
        morale: 'Fighter morale may change',
        reputation: 'Promotion reputation may change'
      }
    }
  },
  calendar: {
  ...
  generated: {
    objectives: { reward: 'Season objective completed: {{kind}}' },
    drama: { decisionTitle: 'Backstage decision', decisionBody: '{{fighter}}: the promotion chose {{response}}.', unknownFighter: 'Fighter', rivalryDescription: 'A heated rivalry is building.' },
    ...
    career: { retirementTitle: '{{name}} Retires', retirement: '{{name}} has retired from professional MMA.', rookieClassTitle: '{{year}} Rookie Class Arrives', rookieClass: '{{count}} new prospects have entered the free-agent pool.', emergencyProspectsTitle: 'Emergency Prospects Added', emergencyProspects: '{{count}} prospects have joined the {{weightClass}} free-agent pool.', hallOfFameTitle: '{{name}} Enters the Hall of Fame', hallOfFame: '{{name}} has been inducted into the Hall of Fame with a legacy score of {{score}}.' }
  },
  fight: {
    method: {
      koTko: 'KO/TKO',
